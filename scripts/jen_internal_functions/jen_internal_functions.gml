//This contains internal functions referenced inside of other functions in Jen_scripts.
//These should not be referenced by the user of Jen_scripts. They do not have documentation.

#region _jenternal_autotile(id, xx, yy, test, default);
...
#endregion
#region _jenternal_test(id, x1, y1, test, default);
/// @param id
/// @param x1
/// @param y1
/// @param test
